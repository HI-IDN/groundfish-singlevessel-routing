...
| `plot_mip_runtime.R`          | _(manual)_          | `sol/mip_runtime_vs_size.png`           |
| `make_baseline_table.R`       | _(manual)_          | LaTeX construction/segmentation baseline table printed to stdout |
| `make_refinement_table.R`     | _(manual)_          | LaTeX refinement table and `sol/refinement_transit_sweeps.png` |
